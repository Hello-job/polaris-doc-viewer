...
export const updateCurrentDocument = (document: IDocument): UpdateCurrentDocument => ({
...
export const SET_FILE_NO: string = 'SET_FILE_NO';
export interface SetFileNo {
  type: typeof SET_FILE_NO;
  num: number;
}
export const setFileNo = (num: number): SetFileNo => {
  return {
    type: SET_FILE_NO,
    num,
  };
